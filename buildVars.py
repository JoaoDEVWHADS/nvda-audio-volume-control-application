...
Contact: https://t.me/tierryt2021"""),
	# version
	addon_version="2026.01.12",
	# Brief changelog for this version
	# Translators: what's new content for the add-on version to be shown in the add-on store
	addon_changelog=_("""Initial release with the following features:
- List all applications with active audio sessions
- Control volume per application with keyboard shortcuts
- Set volume to 0% or 100% with Home/End keys
- Real-time volume announcements via NVDA
- Mute/unmute individual applications
- Reset Defaults button (100% volume + unmute all keys)
- Auto-select foreground application"""),
	# Author(s)
	...
	addon_lastTestedNVDAVersion="2030.0",
...
pythonSources: list[str] = [
	...
	"addon/globalPlugins/audioVolumeControl/**/*.py",  # Include all subdirectories
]
